    ...
    <section className="pt-32 pb-24">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose-custom space-y-10 text-text-muted leading-relaxed">
          <section>
            <h2 className="font-heading text-h3 text-text-primary mb-4">1. Information We Collect</h2>
            <p>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2">
              <li>
                <strong className="text-text-primary">Contact Information:</strong> Name, email address,
                phone number, and business name provided through our contact forms and intake processes.
              </li>
              <li>
                <strong className="text-text-primary">Business Information:</strong> Business type, revenue
                range, operational details, and service needs shared during consultations and onboarding.
              </li>
              <li>
                <strong className="text-text-primary">Usage Data:</strong> Information about how you interact
              ...
              <li>
                <strong className="text-text-primary">Service Data:</strong> Data generated through the use
          ...
          <section>
            <h2 className="font-heading text-h3 text-text-primary mb-4">2. How We Use Your Information</h2>
            <p>We use the information we collect for the following purposes:</p>
            <ul className="list-disc list-inside mt-3 space-y-2">
              <li>
                <strong className="text-text-primary">Service Delivery:</strong> To provide, maintain, and
                improve our automation services, SaaS products, and consulting engagements.
              </li>
              <li>
                <strong className="text-text-primary">Communication:</strong> To respond to your inquiries,
                send service updates, and provide technical support.
              </li>
              <li>
                <strong className="text-text-primary">Billing:</strong> To process payments and manage your
                account.
              </li>
              <li>
                <strong className="text-text-primary">Improvement:</strong> To analyze usage patterns and
          ...
          <section>
            <h2 className="font-heading text-h3 text-text-primary mb-4">3. Third-Party Services</h2>
            <p>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2">
              <li>
                <strong className="text-text-primary">CRM &amp; Marketing:</strong> GoHighLevel (GHL) for
                customer relationship management and communication workflows.
              </li>
              <li>
                <strong className="text-text-primary">Payment Processing:</strong> Stripe for secure payment
                processing. We do not store credit card information on our servers.
              </li>
              <li>
                <strong className="text-text-primary">Productivity:</strong> Google Workspace for email
                and document management.
              </li>
              <li>
                <strong className="text-text-primary">AI Services:</strong> OpenAI API for powering
          ...
          <section>
            <h2 className="font-heading text-h3 text-text-primary mb-4">4. Data Retention</h2>
            <p>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2">
              <li>
                <strong className="text-text-primary">Contact form submissions</strong> are retained for the
                duration of any active engagement and for up to two (2) years after the last interaction.
              </li>
              <li>
                <strong className="text-text-primary">Service data</strong> is retained for the duration
                of your subscription and for thirty (30) days after termination, unless you request
                earlier deletion.
              </li>
              <li>
                <strong className="text-text-primary">Billing records</strong> are retained as required by
          ...
          <section>
            <h2 className="font-heading text-h3 text-text-primary mb-4">5. CCPA Compliance (California Residents)</h2>
            <p>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2">
              <li>
                <strong className="text-text-primary">Right to Know:</strong> You may request disclosure of
                the categories and specific pieces of personal information we have collected about you.
              </li>
              <li>
                <strong className="text-text-primary">Right to Delete:</strong> You may request deletion of
                your personal information, subject to certain exceptions.
              </li>
              <li>
                <strong className="text-text-primary">Right to Non-Discrimination:</strong> We will not
                discriminate against you for exercising your CCPA rights.
              </li>
              <li>
                <strong className="text-text-primary">No Sale of Data:</strong> We do not sell personal
          ...
          <section>
            <h2 className="font-heading text-h3 text-text-primary mb-4">6. GDPR Compliance (EU Visitors)</h2>
            <p>
            ...
            <ul className="list-disc list-inside mt-3 space-y-2">
              <li>
                <strong className="text-text-primary">Lawful Basis:</strong> We process your data based on
                legitimate business interest (service delivery) and consent (form submissions).
              </li>
              <li>
                <strong className="text-text-primary">Data Subject Rights:</strong> You have the right to
                access, rectify, erase, restrict processing, and port your personal data.
              </li>
              <li>
                <strong className="text-text-primary">Data Transfers:</strong> Your data may be transferred
          ...
          <section>
            <h2 className="font-heading text-h3 text-text-primary mb-4">7. Cookies</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-h3 text-text-primary mb-4">8. Your Rights</h2>
            <p>
          ...
          <section>
            <h2 className="font-heading text-h3 text-text-primary mb-4">9. Contact for Data Requests</h2>
            <p>
