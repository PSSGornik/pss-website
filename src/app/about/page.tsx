    ...
    <>
      ...
      <section className="py-24 bg-surface/50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <span className="text-label uppercase text-primary mb-4 block">Our Mission</span>
            ...
            <p className="text-xl text-text-muted leading-relaxed mt-6">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <span className="text-label uppercase text-primary mb-4 block">Values</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {values.map((value, i) => (
              <GlassCard key={i}>
                ...
                <h3 className="font-heading text-h3 text-text-primary mb-2">{value.title}</h3>
      ...
      <section className="py-24 bg-surface/50">
        <div className="max-w-7xl mx-auto px-6">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <span className="text-label uppercase text-primary mb-4 block">Team</span>
            <h2 className="font-heading text-h2-mobile md:text-h2 text-text-primary">
          ...
          <div className="glass-card p-12 text-center">
            <p className="text-text-muted">Team section coming soon.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <div>
              <h3 className="font-heading text-h3 text-text-primary mb-1">Based in Phoenix, AZ</h3>
